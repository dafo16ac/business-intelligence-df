...
Solo_Travellers = hotel_data.loc[hotel_data['Travelling Group'] == 'Solo Travellers']
Family = hotel_data.loc[hotel_data['Travelling Group'] == 'Family']
Groups = hotel_data.loc[hotel_data['Travelling Group'] == 'Groups']
Couples = hotel_data.loc[hotel_data['Travelling Group'] == 'Couples']
Business = hotel_data.loc[hotel_data['Travelling Group'] == 'Business']

tot_marks_perc = hotel_data['Travelling Group'].count()
...
Business_nation_rev = Business.groupby('Country')['ADR'].mean().sort_values(ascending=False).index[0]

Solo_Travellers_nation_rating = Solo_Travellers.groupby('Country')['Customer Satisfaction Rating'].mean().sort_values(ascending=False).index[
    0]
...
Business_nation_upselling = Business.groupby('Country')['Additional Expenditures'].mean().sort_values(ascending=False).index[0]
...
table_marks_title = go.Table(
    ...
    header=dict(height=45,
                values=['Sub-Segments by Travel Companion'],
...
values_upselling_st = hotel_data[['Bar', 'Restaurant', 'Other', 'Breakfast', 'ADR']].loc[
    hotel_data['Travelling Group'] == 'Solo Travellers'].sum()
values_upselling_st = values_upselling_st.tolist()

values_upselling_fam = hotel_data[['Bar', 'Restaurant', 'Other', 'Breakfast', 'ADR']].loc[
    hotel_data['Travelling Group'] == 'Family'].sum()
values_upselling_fam = values_upselling_fam.tolist()

values_upselling_groups = hotel_data[['Bar', 'Restaurant', 'Other', 'Breakfast', 'ADR']].loc[
    hotel_data['Travelling Group'] == 'Groups'].sum()
values_upselling_groups = values_upselling_groups.tolist()

values_upselling_Business = hotel_data[['Bar', 'Restaurant', 'Other', 'Breakfast', 'ADR']].loc[
    hotel_data['Travelling Group'] == 'Business'].sum()
values_upselling_Business = values_upselling_Business.tolist()

values_upselling_couples = hotel_data[['Bar', 'Restaurant', 'Other', 'Breakfast', 'ADR']].loc[
    hotel_data['Travelling Group'] == 'Couples'].sum()
